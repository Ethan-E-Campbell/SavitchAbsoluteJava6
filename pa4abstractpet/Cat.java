...
public class Cat extends Pet       
{
     ...
     * 
     * @param original the original cat that creates the new copy
     */
    ...
    /**
     * Cat clone() override calls the Cat copy constructor.
     * 
     * @return A deep copy of this Cat object
     */
    @Override
    public Cat clone()
    {
        return new Cat(this);
    } //end public cat clone
