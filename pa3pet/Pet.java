 ...
 * subclasses as well as drug doses for certain drugs.
 * @version 21-Feb-2021 
...
{ 
     ...
     * 
     * @return the string containing name, age, and weight of pet
     */
    @Override
    ...
    public int hashCode() 
    {
        ...
        hash = 59 * hash + new Double(weight).hashCode();
        return hash;
